#########################################
# "스타fucks" 카페 키오스크 프로그램
# - 일자: 2023년10월13일
# - 작성자: 조태민
# - 내용: 카페 음료 주문 및 판매하는 콘솔 프로그램
...
# 1. 메인 메뉴 출력
print("◼︎" * 15)
print("◼︎◼︎ == 스타fucks == ◼︎◼︎")
print("◼︎◼︎ == ver 1.2  == ◼︎◼︎")
