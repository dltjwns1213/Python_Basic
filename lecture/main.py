...
# - 문자형(char): 'A', 'E' 키보드 제어!, 파이썬에는 따로 없음
...
# name 변수 생성
# "Taemin Jo" 값을 name 변수에 담기

# name(변수명), =(대입연산자), "Taemin Jo"(값)
name = "Taemin Jo"
...
#           ex) printf, for, while, if, else, class, try, True, False...
#
# Naming Method
# - 변수, 함수, 클래스 등의 사용자 정의 이름에 사용하는 기법
# - 프로그래밍 연어별로 사용하는 Naming Method가 다름!
...
# Python        snake_case  snake_case()   PascalCase           중요
...
# 동적 출력!
print("=" * 200)
student_num = 20204474
student_name = "Taemin Jo"

# 출력 예: "조선대학교 20204474, Taemin Jo입니다."
print("조선대학교 20204474, Taemin Jo입니다.") # 하드 코딩 지양!
